...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
        			...
        			<div class="col-xs-12">
						<div class="box">
							...
							<div class="box-body">
                                ...
                                <?php
                                  	$conn= mysqli_connect("localhost","root","","payroll_mdb");
									  $sql="SELECT `pay_month` , `earning_total`, `deduction_total`, `net_salary`  FROM `wy_salaries`";
										 ...
										 <tbody>
											...
											<tr>
												<?php 
														...
														echo "<td>".$row["earning_total"]." </td>";
														echo "<td>".$row["deduction_total"]." </td>";
		...
		<strong> &copy; <?php echo date("Y");?> Payroll Management System | </strong> Developed By Rohit Shinde and Atul Bhosale
		</footer>
	</div>
